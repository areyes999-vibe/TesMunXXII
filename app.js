...
function renderHandbook() {
    return `<div class="flex-1 overflow-y-auto custom-scrollbar page-enter px-8 py-12 lg:px-16">
        <div class="max-w-4xl mx-auto flex flex-col items-center justify-center min-h-[60vh] text-center">
            <span class="material-symbols-outlined text-gray-600 text-8xl mb-6">menu_book</span>
            <h1 class="text-6xl md:text-8xl font-display font-bold text-white leading-none tracking-tighter mb-4">Handbook</h1>
            <p class="text-gray-400 text-lg max-w-xl mb-8">The Delegate Handbook is being prepared and will be available for download soon.</p>
            <div class="bg-[#1c1f4a]/50 border border-white/10 rounded-xl p-8 inline-flex items-center gap-4">
                <span class="material-symbols-outlined text-accent text-3xl">hourglass_top</span>
                <div class="text-left">
                    <p class="text-white font-display uppercase tracking-widest text-sm font-bold">Coming Soon</p>
                    <p class="text-gray-400 text-xs mt-1">Check back later for the full guide.</p>
                </div>
            </div>
        </div>
    </div>`;
